          ...
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Month Revenue</p>
                  <h4 class="mb-0"> N53,000,000.00</h4>
                </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Engagements</p>
                  <h4 class="mb-0">5</h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card ">
            <div class="card-body">
              ...
              <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) increase in month sales. </p>
              <div class="pe-2">
                <div class="chart">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Dantata and Sawoe</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jalal">
                            <img src="{% static "assets/img/team-1.jpg" %}" alt="team1">
                          </a>
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Matthew">
                            <img src="{% static "assets/img/team-2.jpg" %}" alt="team2">
                          </a>
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Abubakar">
                            <img src="{% static "assets/img/team-3.jpg" %}" alt="team3">
                          </a>
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mustapha">
                            <img src="{% static "assets/img/team-4.jpg" %}" alt="team4">
                          </a>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> N150,000,000 </span>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Jaiz Bank Plc</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> N75,000,000 </span>
                      </td>
                      <td class="align-middle">
                        <div class="progress-wrapper w-75 mx-auto">
                          <div class="progress-info">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Eco Bank</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Tastia Restaurant</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold">N200,000,000</span>
                      </td>
                      <td class="align-middle">
                        <div class="progress-wrapper w-75 mx-auto">
                          <div class="progress-info">
